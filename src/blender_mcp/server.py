        ...
        try:
            while True:
                try:
                    ...
                    # PERFORMANCE: Only attempt to parse JSON if the chunk ends with } or ]
                    # This avoids O(N^2) overhead of parsing incomplete JSON in every chunk
                    ...
                    try:
                        data = b''.join(chunks)
                        json.loads(data)  # json.loads handles bytes directly since Python 3.6
