        ...
        try:
            while self.running:
                ...
                try:
                    ...
                    # Performance Optimization: Only attempt JSON parsing if the chunk
                    # ends with a potential JSON terminator (} or ]).
                    # This avoids O(N^2) complexity and list-based accumulation is more
                    # efficient than string/byte concatenation for large payloads.
