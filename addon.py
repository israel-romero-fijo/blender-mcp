        ...
        try:
            while self.running:
                ...
                try:
                    ...
                    # Optimization: Only attempt to parse if the chunk looks like it could be the end of a JSON object/array.
                    # This avoids O(N^2) parsing overhead for multi-chunk payloads.
