        ...
        try:
            while self.running:
                ...
                try:
                    ...
                    chunks.append(data)
                    # Performance optimization: only attempt to parse if the chunk likely ends a JSON object.
                    ...
                    if data.rstrip().endswith((b'}', b']')):
                        try:
                            ...
                            # Use default argument cmd=command to capture the current command value
