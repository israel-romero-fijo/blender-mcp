        ...
        try:
            while self.running:
                ...
                try:
                    ...
                    # Also use list of chunks instead of byte string concatenation to avoid quadratic overhead
                    if data.rstrip().endswith((b'}', b']')):
                        try:
                            ...
                            # Capture command in a closure to avoid issues with subsequent commands
