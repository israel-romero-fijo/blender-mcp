        ...
        try:
            while self.running:
                ...
                try:
                    ...
                    # Performance: Only attempt json.loads if the chunk ends with a JSON terminator
                    if data.rstrip().endswith((b'}', b']')):
                        try:
                            ...
                            # Performance/Bugfix: Pass command as default arg to capture it in the closure
