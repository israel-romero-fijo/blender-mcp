        ...
        try:
            while self.running:
                ...
                try:
                    ...
                    chunks.append(data)
                    # Performance optimization: Only try to parse if the chunk looks like it could end a JSON object/array
                    # and use a list of chunks to avoid O(N^2) buffer re-allocation
