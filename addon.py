        ...
        try:
            while self.running:
                ...
                try:
                    ...
                    # Optimized: Only try to parse if the last non-whitespace byte is a terminator (} or ])
                    last_idx = len(data) - 1
                    while last_idx >= 0 and data[last_idx] in (
                        32,
                        10,
                        13,
                        9,
                    ...
                    if last_idx >= 0 and data[last_idx] in (125, 93):  # } or ]
                        try:
